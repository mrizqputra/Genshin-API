...
function HomePage() {
  ...
  useEffect(() => {
    ...
    const date = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"]
    console.log(date[0]);
    const getWeaponMat = date[new Date().getDay()]
    axios({
      method: "GET",
      ...
      .then(function (response) {
        console.log(response);
        setWeaponMaterialSchedule(response.data);
      })
      .catch(function (err) {
        console.log(err);
      });
  ...
  return (
    ...
    //     <div className="basis-1/4 bg-slate-400 gap-2 px-3">Character</div>
    //     <div className="basis-1/4 bg-slate-400">Artifact</div>
    //     <div className="basis-1/4 bg-slate-400">Talent</div>
    //     <div className="basis-1/4 bg-slate-400">Weapon</div>
    //   </div>
    // </div>
